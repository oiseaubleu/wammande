...
//                   {purchases[item.supplier_purchase_id]?.name || "不明"}
//                 </td>
//                 <td className="py-2 px-4 border-b"> {purchases[item.supplier_purchase_id]?.item_number || "不明"}</td>
//                 <td className="py-2 px-4 border-b">{item.quantity}</td>
...
//         `http://localhost:3000/suppliers/${order.supplier_id}`,
//         {
//           mode: "cors",
//         }
//       );
...
//                   {/*これはない*/}
//                 </td>
//                 <td className="py-2 px-4 border-b">{item.item_number}</td>
//                 {/*これはない*/}
//                 <td className="py-2 px-4 border-b">{item.quantity}</td>
//                 <td className="py-2 px-4 border-b">€{item.unit_price}</td>
//                 {/*これはない*/}
